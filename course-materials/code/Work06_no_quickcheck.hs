...
{- Use this file if you cannot install QuickCheck -}
...
fact_correct :: Nat -> Bool
fact_correct n = fact' n == fact n
...
exp_correct :: Nat -> Nat -> Bool
exp_correct b n = exp' b n == exp b n
...
fib_correct1 :: Nat -> Bool
fib_correct1 n = fib' n == fib n
...
fib_correct2:: Nat -> Bool
fib_correct2 n = fib'' n == fib n
